...
//            try
//            {
//                var Rols = await _UserBusiness.GetAllUsersAsync();
//                return Ok(Rols);
//            }
...
//            try
//            {
//                var update = await _UserBusiness.UpdateUserAsync(UserDto);
//                return Ok(update);
//            }
//            catch (ValidationException ex)
//            {
...
//        [ProducesResponseType(404)]
//        [ProducesResponseType(500)]
//        public async Task<IActionResult> DeletleUser(int id)
//        {
//            try
//            {
//                var response = await _UserBusiness.DeletelogicaUserlAsync(id);
//                return Ok(response);
//            }
//            catch (ValidationException ex)
//            {
...
//            try
//            {
//                var response = await _UserBusiness.DeletePersistenUserAsync(id);
