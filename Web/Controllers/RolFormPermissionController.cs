...
//            try
//            {
//                var update = await _RolFormPermissionBusiness.UpdateRolFormPermissionAsync(RolFormPermissionDto);
//                return Ok(update);
//            }
//            catch (ValidationException ex)
//            {
...
//            try
//            {
//                var response = await _RolFormPermissionBusiness.DeletePersistenRolFormPermissionAsync(id);
