...
//    {
//        private readonly IGlobalLinq<User> _UserData;
//        private readonly ILogger<UserBusiness> _logger;

//        public UserBusiness(IDataFactoryGlobal dataFactory, ILogger<UserBusiness> logger)
//        {
//            _UserData = dataFactory.CreatePersonData();
//            _logger = logger;
//        }
...
//            try
//            {
//                var Useres = await _UserData.GetAllAsyncLinq();
...
//            try
//            {
//                var User = await _UserData.GetByIdAsyncLinq(id);
//                if (User == null)
//                {
...
//                var UserCreado = await _UserData.CreateAsyncLinq(User);
...
//                ValidateUser(UserDto);
//                int id = UserDto.Id;
//                var UserValid = await _UserData.GetByIdAsyncLinq(id);

//                var User = MapToEntity(UserDto);
//                var updateUser = await _UserData.UpdateAsyncLinq(User);
...
//            try
//            {
//                var User = await _UserData.DeleteLogicalAsyncLinq(id);
//                if (User == null)
//                {
//                    _logger.LogInformation("No se encontró ningún User con ID: {UserId}", id);
//                    throw new EntityNotFoundException("User", id);
...
//            try
//            {
//                var User = await _UserData.DeletePersistentAsyncLinq(id);
//                if (User == null)
//                {
//                    _logger.LogInformation("No se encontró ningún User con ID: {UserId}", id);
//                    throw new EntityNotFoundException("User", id);
