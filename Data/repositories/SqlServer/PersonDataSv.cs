...
{
    public class PersonDataSv : IGlobalCrud<Person>
    {
        private readonly ApplicationDbContext _context;
        private readonly ILogger<PersonDataSv> _logger;
        public PersonDataSv(ApplicationDbContext context, ILogger<PersonDataSv> logger)
        {
            _context = context;
            this._logger = logger;
        }
